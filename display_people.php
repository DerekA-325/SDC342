...
<body>
    ...
    <td><form method="POST">
        <input type="hidden" name="pNoUpd" value="<?php echo $person->getPersonNo(); ?>"/>
        <input type="submit" value="Update" name="update" />
    </form></td>
    <td><form method="POST">
        <input type="hidden" name="pNoDel" value="<?php echo $person->getPersonNo();?>"/>
    ...
    <table>
        ...
        <?php foreach(PersonController::getPeopleByRole($role->getRoleNo()) as $person) : ?>
        <tr>
            <td><?php echo $person->getFirstName(); ?></td>
            <td><?php echo $person->getLastName(); ?></td>
            <td><?php echo $person->getStartDate(); ?></td>
